        ...
        <div class="container mt-5">
            ...
            <form method="post" action="<?php echo base_url('/createuser') ?>">
                <div class="mb-3">
                    ...
                    <input type="text" name="first_name" class="form-control" value="<?php echo old('first_name') ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="last_name" class="form-control" value="<?php echo old('last_name') ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="birth_date" class="form-control datepicker" value="<?php echo old('birth_date') ?>">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="address" class="form-control"><?php echo old('address'); ?></textarea>
